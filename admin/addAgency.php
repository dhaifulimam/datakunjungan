    ...
    <div class="main-container d-flex">
        ...
        <div class="content">
            ...
            <div class="mainContent">
                <div class="title">
                    <h1 class="titleContent">Tambah Instansi</h1>
                </div>
                <div class="formAdm">
                    <form action="" method="POST">
                        <div class="form-group">
                            <label for="nama">nama instansi</label>
                            <input type="text" name="namaInstansi" class="form-control" id="nama" autocomplete="off" required>
                        </div>
                        <div class="row d-flex mx-auto btnAdd">
                            <button type="submit" name="daftar" class="btn btn-success add">tambah</button>
                        </div>
                    </form>
                </div>
