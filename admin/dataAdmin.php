...
$data = query("SELECT * FROM dtadmin");
...
<head>
    ...
    <link rel="stylesheet" href="css/dtAdmin.css">
    ...
    <div class="main-container d-flex">
        <div class="sidebar" id="side-nav">
            ...
            <ul class="list-unstyled items">
                ...
                <li class="active"><a class="py-2 px-3 d-block" href="dataAdmin.php"><img class="icon" src="icon/admin.png" alt=""> data admin</a></li>
        ...
        <div class="content">
            ...
            <div class="mainContent">
                <div class="title">
                    <h1 class="titleContent">Data Admin</h1>
                </div>
                <div class="dtTabel">
                    <div class="btnNew d-flex justify-content-end mb-2"><button class="btn btn-primary btnNewAdm "><a href="newAdmin.php">Tambah Admin</a></button></div>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($data as $dt) : ?>
                                <tr>
                                    ...
                                    <td><?= $dt["username"]; ?></td>
                                    <td><?= $dt["password"]; ?></td>
                                    <td><a class="btn btn-warning" href="updateAdmin.php?id=<?= $dt["id"]; ?>">ubah</a>
                                        <a class="btn btn-danger" href="deleteAdmin.php?id=<?= $dt["id"]; ?>">hapus</a>
                                    </td>
                                </tr>
                                <?php $i++; ?>
                            <?php endforeach; ?>
