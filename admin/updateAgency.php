...
$data = query("SELECT * FROM dtinstansi WHERE id = $id")[0];

if (isset($_POST["submit"])) {

    if (ubahinstansi($_POST) > 0) {
        echo "
              <script>
                ...
                <div class="formAdm">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="namaInstansi" class="form-control" id="nama" autocomplete="off" value="<?= $data["namaInstansi"]; ?>">
                        </div>
